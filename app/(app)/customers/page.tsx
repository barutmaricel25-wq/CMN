  ...
  return (
    <div className="space-y-3">
      <div className="flex justify-between items-center">
        ...
        <button className="btn-primary !py-2" onClick={() => setEditing({ id: uid(), name: "", phone: "", type: "retail", address: "", notes: "", active: true })}>+ Add</button>
      </div>
              ...
              <div className="flex justify-between items-start gap-2">
                <div className="min-w-0">
                  <div className="font-semibold text-sm truncate">
                    {c.name}
                    <span className={`badge ml-2 ${c.type === "retail" ? "bg-slate-200 text-slate-700" : c.type === "suki" ? "bg-amber-100 text-amber-800" : "bg-blue-100 text-blue-800"}`}>{c.type}</span>
                  </div>
      ...
      <div className="card w-full max-w-lg max-h-[90vh] overflow-y-auto p-5 rounded-b-none sm:rounded-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="text-xs text-slate-500">{customer.type} · {customer.phone}</div>
