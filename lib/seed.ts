...
export function buildSeed(): DB {
  ...
  const customers: Customer[] = CUSTOMER_DEFS.map((c, i) => ({
    id: `c${i + 1}`, branch_id: branches[i % branches.length].id, name: c[0], phone: c[1], cp_number: c[1], type: c[2], address: c[3], notes: c[4], active: true,
  ...
  const pdc_checks: PDCCheck[] = [
    {
      ...
      check_number: "0012345", check_name: "", bank: "BDO", amount: P(85000),
    ...
    },
    {
      ...
      customer_id: null, delivery_id: null, branch_id: "b1",
      check_number: "0012399", check_name: "", bank: "Metrobank", amount: P(46500),
    ...
    },
    {
      ...
      check_number: "0455121", check_name: "", bank: "Landbank", amount: P(18400),
